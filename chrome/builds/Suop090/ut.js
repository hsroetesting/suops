...
for(var elpon = 0; elpon <= sumem[0].groups.length - 1; elpon++) {
	var curg = document.createElement('div');
		...
		curg.setAttribute('style','padding-bottom: 10px;margin-left: 40px;background-color: #fffff;');
		curg.innerHTML = sumem[0].groups[elpon].name + "<div id='group_" + elpon + "_channels' style='display: none; padding-bottom: 5px; padding-top: 5px; margin-left: -40px;'></div>";
